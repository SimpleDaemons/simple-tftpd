...
REMOTE_PROJECT_DIR="/opt/simple-tftpd"
...
- name: Collect packages from remote VMs
  ...
  vars:
    ...
    remote_dist_dir: "/opt/simple-tftpd/dist"
    remote_build_dir: "/opt/simple-tftpd/build"
    remote_centralized_dir: "/opt/simple-tftpd/dist/centralized/v$VERSION"
